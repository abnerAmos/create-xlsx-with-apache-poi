...
public class CreateExcel {
    ...
    private void addCell(Row line, int column, String valor) { // Método que adiciona campos com valor String
    ...
    private void addCell(Row line, int column, int valor) { // Método que adiciona campo com valor Integer
        Cell cell = line.createCell(column);    // Informa qual coluna esta posicionado
        cell.setCellValue(valor);               // Informa o valor da coluna/linha
    }
}
